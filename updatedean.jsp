...
String sql ="select * from dean WHERE Name='"+Name+"'";
ResultSet rs = st.executeQuery(sql);
while(rs.next()){
%>
<body>
<center>
<form method="post" action="updatedean2.jsp">
  <table>
    <tr>
    ...
    <tr>
      ...
      <td align="left"><input type="text" name="desg" value="<%=rs.getString("Incharge")%>" /></td>
    </tr><tr></tr><tr></tr><tr></tr>
    <tr>
      <td align="right">Department:</td>
