<html>
<head>
<title>UPDATE RC BOYS HOSTEL</title>
<style>
body{
	font-size:30px;
	text-align:center;
...
String sql ="select * from residentcounsellorsb1 WHERE Name='"+Name+"'";
ResultSet rs = st.executeQuery(sql);
while(rs.next()){
%>
<body>
<center>
<form method="post" action="updatercb2.jsp">
  <table>
    <tr>
	...
	<td align="right">Contact Number:</td>
      <td align="left"><input type="text" name="phone" value="<%=rs.getString("Phoneno")%>"/></td>
    </tr><tr></tr><tr></tr><tr></tr>
	<tr>
