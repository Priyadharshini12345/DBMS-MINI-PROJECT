...
<head><script>function p5(){
	window.location.href="http://localhost/priya/adminresb.php";
}
</script>
...
String sql="UPDATE residentcounsellorsb1 SET Name=?,BlockNo=?,Blockname=?,Phoneno=?,Department=?,Emailid=? WHERE Name='"+Name+"'";
